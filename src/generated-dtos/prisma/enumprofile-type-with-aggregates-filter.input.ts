...
import { NestedEnumprofile_typeWithAggregatesFilter } from './nested-enumprofile-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumprofile_typeFilter } from './nested-enumprofile-type-filter.input';

@InputType()
export class Enumprofile_typeWithAggregatesFilter {
